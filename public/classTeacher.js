document.addEventListener("DOMContentLoaded" , () =>{
    ...
    .then(data => {
        data.forEach(alumno => {
            contenedor.innerHTML += ` <a href="/detalleAlumno?idAlumno=${alumno.UID}&idClase=${idClase}"><div style="background-color: #000161" class="rounded m-1 p-3 row mb-3 ps-1 hover">
